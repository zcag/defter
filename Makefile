...
.PHONY: help install build typecheck test lint format demo demo-build storybook deploy pack publish-dry publish clean
...
demo-build: ## Build the demo site
	pnpm demo:build
